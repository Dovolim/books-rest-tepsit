...
/**
 * Client REST che dimostra come interrogare i servizi del books-rest-server.
 *
 * Basato sulla lezione 6 della guida html.it:
 * https://www.html.it/pag/63611/restful-web-services-in-java-con-jersey-il-client/
 *
 * Esegue in sequenza:
 *   1. GET /api/books           (lista tutti)
 *   2. GET /api/books/1         (dettaglio)
 *   3. POST /api/books          (crea nuovo)
 *   4. PUT /api/books/{newId}   (modifica quello appena creato)
 *   5. DELETE /api/books/{newId} (elimina)
 *   6. GET /api/books           (lista finale)
 */
public class BooksClient {
    ...
    public static void main(String[] args) {
        ...
        // Legge l'URL dal primo argomento (opzionale)
        ...
        // Creazione del client Jersey (come da lezione 6 guida html.it)
        Client client = ClientBuilder.newClient();
        WebTarget target = client.target(url);

        // ---------------------------------------------------------------
        // 1. GET /api/books  → Lista tutti i libri
        // ---------------------------------------------------------------
        ...
        // ---------------------------------------------------------------
        // 2. GET /api/books/1  → Dettaglio libro con id=1
        // ---------------------------------------------------------------
        System.out.println("\n--- [2] GET " + url + "/1 ---");
        ...
        // ---------------------------------------------------------------
        // 3. POST /api/books  → Crea un nuovo libro
        // ---------------------------------------------------------------
        ...
        // ---------------------------------------------------------------
        // 4. PUT /api/books/{newId}  → Aggiorna il libro appena creato
        // ---------------------------------------------------------------
    ...
    /**
     * DTO semplice per serializzare/deserializzare il payload JSON dei libri.
     */
